...
public class GestorFaltas {
    ...
    public void addEstudiante(Estudiante nuevo) {
        ...
        if(!cursoCompleto() || buscarEstudiante(nuevo.getApellidos()) != -1){
            ...
            System.out.println("El curso está completo o ya existe el alumno");
        }
    }
     ...
     *  y cuántas
     *  
     *  Se asume todo correcto (el estudiante existe y el nº de faltas a justificar también)
     */
    ...
    private void borrar(int i){
        if (i >= 0 && i < total) { // posición correcta
